...
| 優先序 | 規則 | 範例路徑 | 結果 |
|:------:|------|----------|------|
| 1 | 掃描路徑（右→左）找 `*_ws` → 取前綴 | `/home/user/ros2_humble_ws/docker_osrf_ros2_humble` | `ros2_humble` |
| 2 | 最後一層目錄符合 `docker_*` → 去前綴 | `/home/user/docker_osrf_ros2_humble` | `osrf_ros2_humble` |
