...
|:--------:|------|-------------|--------|
| 1 | Scan path (right→left) for `*_ws` → use prefix | `/home/user/ros2_humble_ws/docker_osrf_ros2_humble` | `ros2_humble` |
| 2 | Last directory matches `docker_*` → strip prefix | `/home/user/docker_osrf_ros2_humble` | `osrf_ros2_humble` |
